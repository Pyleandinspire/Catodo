...
const ChatMessageEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'visibleToModel': PropertySchema(
      id: 4,
      name: r'visibleToModel',
      type: IsarType.bool,
    )
  },
...
void _chatMessageEntitySerialize(
  ...
  writer.writeBool(offsets[4], object.visibleToModel);
}
...
ChatMessageEntity _chatMessageEntityDeserialize(
  ...
  final object = ChatMessageEntity(
    ...
    sessionId: reader.readLong(offsets[3]),
    visibleToModel: reader.readBoolOrNull(offsets[4]) ?? true,
  );
  object.id = id;
  return object;
}
...
extension ChatMessageEntityQueryFilter
  ...
  QueryBuilder<ChatMessageEntity, ChatMessageEntity, QAfterFilterCondition>
      visibleToModelEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'visibleToModel',
        value: value,
      ));
    });
  }
...
extension ChatMessageEntityQuerySortBy
  ...
  QueryBuilder<ChatMessageEntity, ChatMessageEntity, QAfterSortBy>
      sortByVisibleToModel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visibleToModel', Sort.asc);
    });
  }

  QueryBuilder<ChatMessageEntity, ChatMessageEntity, QAfterSortBy>
      sortByVisibleToModelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visibleToModel', Sort.desc);
    });
  }
}
...
extension ChatMessageEntityQueryWhereDistinct
  ...
  QueryBuilder<ChatMessageEntity, ChatMessageEntity, QDistinct>
      distinctByVisibleToModel() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'visibleToModel');
    });
  }
}
...
extension ChatMessageEntityQueryProperty
  ...
  QueryBuilder<ChatMessageEntity, int, QQueryOperations> sessionIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sessionId');
    });
  }

  QueryBuilder<ChatMessageEntity, bool, QQueryOperations>
      visibleToModelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'visibleToModel');
    });
  }
}
