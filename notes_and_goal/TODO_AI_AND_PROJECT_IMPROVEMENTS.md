...
| A2 | ⬜ | API Key 安全存储 + 错误分级提示 | PLAN-AI-001-2 |
| A3 | ⬜ | 任务输入框 NLP 实时预览（含可选 AI 高准确解析按钮） | PLAN-AI-001-3 |
| A4 | ⬜ | AI 时间安排优化助手（看当前任务 → 给优化建议 → 自动调整时间 / 自动拆解） | PLAN-AI-001-4 |
...
| A10 | ⬜ | AgentActionType.fromString 未知动作 → 不执行 + 提示 | 修掉 fallback 到 createTask 的隐患 |
